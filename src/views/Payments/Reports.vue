        ...
        <div id="form-search-data">
            ...
            <div class="row" id="form-label-input">
                <div class="col-2" id="align-text-fai">
                    <font-awesome-icon id="fai-search" :icon="['fas', 'list-ol']" /><label
                        class="form-label">Nit</label>
                    <input v-on:keyup="searchNit()" v-model="nit" type="text" class="form-control"
                        placeholder="901123456-1">
                </div>

                <div class="col-2" id="align-text-fai">
                    <font-awesome-icon id="fai-search" :icon="['fas', 'credit-card']" /><label
                        class="form-label">Sale</label>
                    <input v-on:keyup="searchSale()" v-model="sale" type="text" class="form-control"
                        placeholder="HJMJ456789">
                </div>

                <div class="col-2" id="align-text-fai">
                    <font-awesome-icon id="fai-search" :icon="['fas', 'calendar']" /><label
                ...
                <div class="row" id="form-search-parameters">
                    ...
                    <div class="col-2" id="align-text-fai">
                        <font-awesome-icon id="fai-search" :icon="['fas', 'calendar']" /><label
                            class="form-label">Initial date</label>
                        <input v-model="date_init" type="text" class="form-control" placeholder="2022-01-01">
                    </div>

                    <div class="col-2" id="align-text-fai">
                        <font-awesome-icon id="fai-search" :icon="['fas', 'calendar']" /><label class="form-label">Final
                            date</label>
            ...
            <a id="btn-search-export" title="Export report" type="submit" class="btn" @click="expReport">
                <font-awesome-icon id="fai-export" :icon="['fas', 'file-export']" />
            </a>
